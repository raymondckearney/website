      ...
      <main>
        ...
        {(project.impact.length > 0 || project.richImpact) && (
          <section className="flex flex-col lg:flex-row min-h-[400px]">
            ...
            <div className={`w-full lg:w-[58%] overflow-hidden min-h-[360px] flex items-center justify-center ${project.moodImageFit === 'contain' ? 'bg-white' : 'bg-gray-100'}`}>
              {project.moodImage && (
                <img
            ...
            <div className="w-full lg:w-[42%] px-8 xl:px-10 py-8 flex flex-col justify-start">
              {project.richImpact ? (
